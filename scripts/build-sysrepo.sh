...
build_package() {
    ...
    rm -rf *
    cmake -DCMAKE_INSTALL_PREFIX=/usr -DBUILD_HICNPLUGIN=OFF -DBUILD_HICNLIGHT=OFF \
          -DBUILD_LIBMEMIF=OFF -DBUILD_LIBYANG=ON -DBUILD_LIBTRANSPORT=OFF \
    ...
    cmake -DCMAKE_INSTALL_PREFIX=/usr -DBUILD_HICNPLUGIN=OFF -DBUILD_HICNLIGHT=OFF \
          -DBUILD_LIBMEMIF=OFF -DBUILD_SYSREPOPLUGIN=ON  -DBUILD_SYSREPO=ON -DBUILD_LIBTRANSPORT=OFF \
          -DBUILD_CTRL=OFF -DBUILD_UTILS=OFF ${SCRIPT_PATH}/..
    make package
