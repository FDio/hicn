...
build_package() {
    ...
    rm -rf *
    cmake -DCMAKE_INSTALL_PREFIX=/usr -DBUILD_LIBHICN=OFF -DBUILD_HICNLIGHT=OFF \
           -DBUILD_LIBYANG=ON -DBUILD_LIBTRANSPORT=OFF -DBUILD_CTRL=OFF \
           -DBUILD_UTILS=OFF ${SCRIPT_PATH}/..
   
    make install
    cmake -DCMAKE_INSTALL_PREFIX=/usr -DBUILD_LIBHICN=OFF -DBUILD_HICNLIGHT=OFF \
           -DBUILD_SYSREPO=ON -DBUILD_LIBTRANSPORT=OFF -DBUILD_CTRL=OFF \
           -DBUILD_UTILS=OFF ${SCRIPT_PATH}/..
    make install
    make package
    ...
    cmake -DCMAKE_INSTALL_PREFIX=/usr -DBUILD_HICNLIGHT=OFF -DBUILD_HICNPLUGIN=ON\
           -DBUILD_SYSREPOPLUGIN=ON  -DBUILD_LIBTRANSPORT=OFF -DBUILD_CTRL=OFF \
           -DBUILD_UTILS=OFF ${SCRIPT_PATH}/..
    make package
