...
PACKAGECLOUD_RELEASE_REPO="https://packagecloud.io/install/repositories/fdio/release/script.rpm.sh"

BUILD_TOOLS_UBUNTU="build-essential doxygen"
LIBSSL_LIBEVENT_UBUNTU="libevent-dev libssl-dev"
DEPS_UBUNTU="${LIBSSL_LIBEVENT_UBUNTU} libparc-dev libasio-dev"

BUILD_TOOLS_GROUP_CENTOS="'Development Tools'"
DEPS_CENTOS="${LIBSSL_LIBEVENT_CENTOS} libparc-devel asio-devel"
...
setup_fdio_repo() {
    ...
    if [ "${DISTRIB_ID}" == "ubuntu" ]; then
        curl -s ${PACKAGECLOUD_RELEASE_REPO} | sudo bash
