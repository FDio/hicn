...
static u8 *
format_hicn_hs_input_trace (u8 * s, va_list * args)
{
  return NULL;
}
...
static uword
hicn_hs_input (vlib_main_t * vm, vlib_node_runtime_t * node,
	    vlib_frame_t * frame)
{
...
/* *INDENT-OFF* */
VLIB_REGISTER_NODE (hicn_hs_input_node) =
{
  .function = hicn_hs_input,
  .name = HICN_HS_INPUT_NODE_NAME,
  .vector_size = sizeof (u32),
  .format_trace = format_hicn_hs_input_trace,
