...
connection_t *
connection_table_lookup(const connection_table_t * table,
...
connection_table_remove_by_id(connection_table_t * table, off_t id)
{
    ...
    pool_put(table->connections, connection); // XXX wrong
}

#if 0
unsigned
connection_table_add(connection_table_t * table, connection_t * connection)
{
