...
#define connection_get_local(C) (address_pair_local(connection_get_pair(C)))
#define connection_get_remote(C) (address_pair_remote(connection_get_pair(C)))
#define connection_is_up(C) ((C)->up)
...
uint8_t * connection_send_packet(const connection_t * connection,
...
void connection_detect_losses(const connection_t * connection, msgbuf_t * msgbuf);

void connection_handle_notification(const connection_t * connection, msgbuf_t * msgbuf);
