...
/*
 * Note: this requires both fields to be consecutive in the listener data
 * structure.
 */
#define listener_get_key(listener) ((listener_key_t *)&listener_get_type(listener))
...
listener_t * listener_table_lookup(listener_table_t * table,
