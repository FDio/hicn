...
fib_entry_nexthops_add(fib_entry_t * fib_entry, unsigned nexthop)
{
    ...
    strategy_vft[fib_entry->strategy.type]->add_nexthop(&fib_entry->strategy, nexthop);
}
...
fib_entry_nexthops_remove(fib_entry_t * fib_entry, unsigned nexthop)
{
    ...
    strategy_vft[fib_entry->strategy.type]->remove_nexthop(&fib_entry->strategy, nexthop);
}
