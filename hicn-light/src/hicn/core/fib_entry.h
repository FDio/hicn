...
void fib_entry_receive_data(fib_entry_t * fib_entry, const nexthops_t * nexthops,
...
nexthops_t * fib_entry_nexthops_get_available(fib_entry_t *fib_entry,
    unsigned in_connection, nexthops_t * new_nexthops);
void fib_entry_on_timeout(fib_entry_t *fib_entry, const nexthops_t *egressId);
const nexthops_t * fib_entry_nexthops_get_from_strategy(fib_entry_t *fib_entry,
