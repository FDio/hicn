 ...
 * update.
 */
void mapme_send_updates(const MapMe * mapme, fib_entry_t * fib_entry, const nexthops_t * nexthops);
 ...
 * update.
 */
void mapme_maybe_send_updates(const MapMe * mapme, fib_entry_t * fib_entry, const nexthops_t * nexthops);
 ...
 * @param [in] fib_entry - The FIB entry to consider
 */
void mapme_reconsiderfib_entry_t(const MapMe *mapme, fib_entry_t * fib_entry);
 ...
 */
nexthops_t * mapme_getNextHops(const MapMe *mapme, fib_entry_t *fib_entry,
