 ...
 */
bool forwarder_add_or_update_policy(Forwarder *forwarder, add_policy_command *control);
...
void forwarder_cache_set_store_flag(Forwarder *forwarder, bool val);

bool forwarder_cache_get_store_flag(Forwarder *forwarder);

void forwarder_cache_set_serve_flag(Forwarder *forwarder, bool val);

bool forwarder_cache_get_serve_flag(Forwarder *forwarder);

void forwarder_cache_clear(Forwarder *forwarder);
