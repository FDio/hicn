...
void configuration_ReceiveCommand(Configuration *config, command_type_t command_type,
        uint8_t * packet, unsigned connection_id)
{
    ...
    struct iovec *response =
        configuration_DispatchCommand(config, command_type, packet, connection_id);
