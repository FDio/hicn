...
static void             _strategyRnd_ReceiveObject(StrategyImpl *strategy, const NumberSet *egressId, const Message *objectMessage, Ticks rtt);
static void             _strategyRnd_OnTimeout(StrategyImpl *strategy, const NumberSet *egressId);
static NumberSet *_strategyRnd_LookupNexthop(StrategyImpl *strategy, const Message *interestMessage);
...
static void             _strategyRnd_AddNexthop(StrategyImpl *strategy, unsigned connectionId);
static void             _strategyRnd_RemoveNexthop(StrategyImpl *strategy, unsigned connectionId);
...
strategyRnd_Create()
{
    ...
    parcAssertNotNull(strategy, "parcMemory_AllocateAndClear(%zu) returned NULL", sizeof(StrategyRnd));
...
strategy_type
_strategyRnd_GetStrategy(StrategyImpl *strategy)
{
...
static void
_strategyRnd_ReceiveObject(StrategyImpl *strategy, const NumberSet *egressId, const Message *objectMessage, Ticks rtt)
{
}

static void
_strategyRnd_OnTimeout(StrategyImpl *strategy, const NumberSet *egressId)
{
}

static NumberSet *
_strategyRnd_LookupNexthop(StrategyImpl *strategy, const Message *interestMessage)
{
...
static NumberSet *
_strategyRnd_ReturnNexthops(StrategyImpl *strategy)
{
    StrategyRnd *srnd = (StrategyRnd *) strategy->context;
...
unsigned
_strategyRnd_CountNexthops(StrategyImpl *strategy)
{
    StrategyRnd *srnd = (StrategyRnd *) strategy->context;
...
static void
_strategyRnd_AddNexthop(StrategyImpl *strategy, unsigned connectionId)
{
    StrategyRnd *srnd = (StrategyRnd *) strategy->context;
...
static void
_strategyRnd_RemoveNexthop(StrategyImpl *strategy, unsigned connectionId)
{
    StrategyRnd *srnd = (StrategyRnd *) strategy->context;
...
static void
_strategyRnd_ImplDestroy(StrategyImpl **strategyPtr)
{
