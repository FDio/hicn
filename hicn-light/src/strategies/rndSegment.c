...
static void             _strategyRndSegment_ReceiveObject(StrategyImpl *strategy, const NumberSet *egressId, const Message *objectMessage, Ticks rtt);
static void             _strategyRndSegment_OnTimeout(StrategyImpl *strategy, const NumberSet *egressId);
static NumberSet *_strategyRndSegment_LookupNexthop(StrategyImpl *strategy, const Message *interestMessage);
...
static void             _strategyRndSegment_AddNexthop(StrategyImpl *strategy, unsigned connectionId);
static void             _strategyRndSegment_RemoveNexthop(StrategyImpl *strategy, unsigned connectionId);
...
strategyRndSegment_Create()
{
    ...
    parcAssertNotNull(strategy, "parcMemory_AllocateAndClear(%zu) returned NULL", sizeof(StrategyRndSegment));
...
strategy_type
_strategyRndSegment_GetStrategy(StrategyImpl *strategy)
{
...
static void
_strategyRndSegment_ReceiveObject(StrategyImpl *strategy, const NumberSet *egressId, const Message *objectMessage, Ticks rtt)
{
}

static void
_strategyRndSegment_OnTimeout(StrategyImpl *strategy, const NumberSet *egressId)
{
}

static NumberSet *
_strategyRndSegment_LookupNexthop(StrategyImpl *strategy, const Message *interestMessage)
{
    ...
    if ((nexthopSize == 0) || ((nexthopSize == 1) && numberSet_Contains(srnd->nexthops, in_connection))) {
...
static NumberSet *
_strategyRndSegment_ReturnNexthops(StrategyImpl *strategy)
{
    StrategyRndSegment *srnd = (StrategyRndSegment *) strategy->context;
...
unsigned
_strategyRndSegment_CountNexthops(StrategyImpl *strategy)
{
    StrategyRndSegment *srnd = (StrategyRndSegment *) strategy->context;
...
static void
_strategyRndSegment_AddNexthop(StrategyImpl *strategy, unsigned connectionId)
{
    StrategyRndSegment *srnd = (StrategyRndSegment *) strategy->context;
...
static void
_strategyRndSegment_RemoveNexthop(StrategyImpl *strategy, unsigned connectionId)
{
    StrategyRndSegment *srnd = (StrategyRndSegment *) strategy->context;
...
static void
_strategyRndSegment_ImplDestroy(StrategyImpl **strategyPtr)
{
