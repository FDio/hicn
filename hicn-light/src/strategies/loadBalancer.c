...
static void             _strategyLoadBalancer_ReceiveObject(StrategyImpl *strategy, const NumberSet *egressId, const Message *objectMessage, Ticks rtt);
static void             _strategyLoadBalancer_OnTimeout(StrategyImpl *strategy, const NumberSet *egressId);
static NumberSet *_strategyLoadBalancer_LookupNexthop(StrategyImpl *strategy, const Message *interestMessage);
...
static void             _strategyLoadBalancer_AddNexthop(StrategyImpl *strategy, unsigned connectionId);
static void             _strategyLoadBalancer_RemoveNexthop(StrategyImpl *strategy, unsigned connectionId);
...
strategyLoadBalancer_Create()
{
    ...
    parcAssertNotNull(strategy, "parcMemory_AllocateAndClear(%zu) returned NULL", sizeof(StrategyLoadBalancer));
...
strategy_type
_strategyLoadBalancer_GetStrategy(StrategyImpl *strategy)
{
...
static void
_strategyLoadBalancer_ReceiveObject(StrategyImpl *strategy, const NumberSet *egressId, const Message *objectMessage, Ticks rtt)
{
    _strategyLoadBalancer_OnTimeout(strategy, egressId);
}

static void
_strategyLoadBalancer_OnTimeout(StrategyImpl *strategy, const NumberSet *egressId)
{
...
static NumberSet *
_strategyLoadBalancer_LookupNexthop(StrategyImpl *strategy, const Message *interestMessage)
{
    StrategyLoadBalancer *lb = (StrategyLoadBalancer *) strategy->context;
...
static NumberSet *
_strategyLoadBalancer_ReturnNexthops(StrategyImpl *strategy)
{
    StrategyLoadBalancer *lb = (StrategyLoadBalancer *) strategy->context;
    return lb->nexthops;
}
...
unsigned
_strategyLoadBalancer_CountNexthops(StrategyImpl *strategy)
{
    StrategyLoadBalancer *lb = (StrategyLoadBalancer *) strategy->context;
...
static void
_strategyLoadBalancer_resetState(StrategyImpl *strategy)
{
    StrategyLoadBalancer *lb = (StrategyLoadBalancer *) strategy->context;
    lb->weights_sum = 0.0;
...
static void
_strategyLoadBalancer_AddNexthop(StrategyImpl *strategy, unsigned connectionId)
{
...
static void
_strategyLoadBalancer_RemoveNexthop(StrategyImpl *strategy, unsigned connectionId)
{
    StrategyLoadBalancer *lb = (StrategyLoadBalancer *) strategy->context;
...
static void
_strategyLoadBalancer_ImplDestroy(StrategyImpl **strategyPtr)
{
