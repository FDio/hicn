 ...
 * @constant MissiveType_ConnectionUp        Connection is active and passing data
 * @constant MissiveType_ConnectionDown      Connection is inactive and cannot pass data
 * @constant MissiveType_ConnectionClosed    Connection closed and will be destroyed
