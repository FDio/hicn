...
MissiveDeque *
missiveDeque_Create(void)
{
    MissiveDeque *missiveDeque = parcMemory_AllocateAndClear(sizeof(MissiveDeque));
    parcAssertNotNull(missiveDeque, "parcMemory_AllocateAndClear(%zu) returned NULL", sizeof(MissiveDeque));
    missiveDeque->queue = parcDeque_Create();
    return missiveDeque;
}

void
missiveDeque_Release(MissiveDeque **dequePtr)
{
...
MissiveDeque *
missiveDeque_Append(MissiveDeque *deque, Missive *missive)
{
...
Missive *
missiveDeque_RemoveFirst(MissiveDeque *deque)
{
    parcAssertNotNull(deque, "Parameter deque must be non-null");
...
size_t
missiveDeque_Size(const MissiveDeque *deque)
{
    parcAssertNotNull(deque, "Parameter deque must be non-null");
