...
parcObject_Override(Missive, PARCObject,
                    .isLockable = false);

Missive *
missive_Create(MissiveType missiveType, unsigned connectionid)
{
...
void
missive_Release(Missive **missivePtr)
{
    parcObject_Release((void **) missivePtr);
}

MissiveType
missive_GetType(const Missive *missive)
{
...
unsigned
missive_GetConnectionId(const Missive *missive)
{
    parcAssertNotNull(missive, "Parameter missive must be non-null");
