 ...
 */
void messenger_Register(Messenger *messenger, const MessengerRecipient *recipient);

/**
 * @function eventMessenger_Unregister
 * @abstract Stop receiving event messages
 */
void messenger_Unregister(Messenger *messenger, const MessengerRecipient *recipient);
#endif // messenger_h
