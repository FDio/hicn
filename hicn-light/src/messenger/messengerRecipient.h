 ...
 * @constant missive The missive, recipient must call {@link missive_Release} on it
 */
typedef void (MessengerRecipientCallback)(MessengerRecipient *recipient, Missive *missive);

/**
 * Creates a Recipient, which represents a reciever of missives.
 *
 * Creates a Recipient that can be registerd with the Messenger using {@link messenger_Register}.
 *
 ...
 */
MessengerRecipient *messengerRecipient_Create(void *recipientContext,
                                                            MessengerRecipientCallback *recipientCallback);
 ...
 */
void messengerRecipient_Deliver(MessengerRecipient *recipient, Missive *missive);
