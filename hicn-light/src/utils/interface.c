...
char *
interfaceToString(const Interface *interface)
{
...
Interface *
interfaceCreate(const char *name, unsigned interfaceIndex, bool loopback, bool supportMulticast, unsigned mtu)
{
    Interface *iface = parcMemory_AllocateAndClear(sizeof(Interface));

    parcAssertNotNull(iface, "parcMemory_AllocateAndClear(%zu) returned NULL", sizeof(Interface));
...
void
interfaceDestroy(Interface **interfacePtr)
{
    parcAssertNotNull(interfacePtr, "Parameter must be non-null double pointer");
    parcAssertNotNull(*interfacePtr, "Parameter must dereference to non-null pointer");
...
void
interfaceAddAddress(Interface *iface, Address *address)
{
...
const AddressList *
interfaceGetAddresses(const Interface *iface)
{
    parcAssertNotNull(iface, "Parameter iface must be non-null");
...
unsigned
interfaceGetInterfaceIndex(const Interface *iface)
{
    parcAssertNotNull(iface, "Parameter iface must be non-null");
...
bool
interfaceNameEquals(const Interface *iface, const char *name)
{
    parcAssertNotNull(iface, "Parameter iface must be non-null");
...
bool
interfaceEquals(const Interface *a, const Interface *b)
{
    if (a == NULL && b == NULL) {
        return true;
    }
...
const char *
interfaceGetName(const Interface *iface)
{
    parcAssertNotNull(iface, "Parameter iface must be non-null");
    return iface->name;
}
...
unsigned
interfaceGetMTU(const Interface *iface)
{
    parcAssertNotNull(iface, "Parameter iface must be non-null");
    return iface->mtu;
}
