...
/**
 * Create a new instance of `ListTimeOrdered` that will maintain the order of its
 ...
 *
 */
ListTimeOrdered *listTimeOrdered_Create(TimeOrderList_KeyCompare *keyCompareFunction);
...
/**
 * Add a {@link ContentStoreEntry} instance to the specified list. Note that a new refernece to
 ...
 *
 */
bool listTimeOrdered_Remove(ListTimeOrdered *list, ContentStoreEntry *storeEntry);

/**
 * Return the oldest {@link ContentStoreEntry} instance in this list. That is, the one with the smallest
 * time value.
 *
