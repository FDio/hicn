 ...
 *
 * The hicn-light pointer is primarily used for logging (forwarder_Log), getting the
 ...
 *
 * @param [in] processor the `MessageProcessor` from which to return the ContentStoreInterface.
 *
 */
...
void processor_SetStrategy(MessageProcessor *processor, Name *prefix, strategy_type strategy);
