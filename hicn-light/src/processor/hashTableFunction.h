 ...
 *
 *  * It is reflexive: for any non-null reference value x, `hashTableFunction_MessageNameEquals(x, x)`
 *      must return true.
 *
 ...
 *      invocations of `hashTableFunction_MessageNameEquals(x, y)` consistently return true or
 *      consistently return false.
 *
 *  * For any non-null reference value x, `hashTableFunction_MessageNameEquals(x, NULL)` must
 *      return false.
 *
