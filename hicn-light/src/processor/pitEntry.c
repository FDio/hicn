...
PitEntry *
pitEntry_Create(Message *message, Ticks expiryTime, Ticks creationTime)
{
    PitEntry *pitEntry = parcMemory_AllocateAndClear(sizeof(PitEntry));
    parcAssertNotNull(pitEntry, "parcMemory_AllocateAndClear(%zu) returned NULL", sizeof(PitEntry));
    ...
    numberSet_Add(pitEntry->ingressIdSet, message_GetIngressConnectionId(message));
...
void
pitEntry_Release(PitEntry **pitEntryPtr)
{
    parcAssertNotNull(pitEntryPtr, "Parameter must be non-null double pointer");
    parcAssertNotNull(*pitEntryPtr, "Parameter must dereference to non-null pointer");

    PitEntry *pitEntry = *pitEntryPtr;
    parcTrapIllegalValueIf(pitEntry->refcount == 0, "Illegal state: has refcount of 0");
...
PitEntry *
pitEntry_Acquire(PitEntry *original)
{
...
void
pitEntry_AddIngressId(PitEntry *pitEntry, unsigned ingressId)
{
...
void
pitEntry_AddEgressId(PitEntry *pitEntry, unsigned egressId)
{
    parcAssertNotNull(pitEntry, "Parameter pitEntry must be non-null");
...
void
pitEntry_AddFibEntry(PitEntry *pitEntry, FibEntry *fibEntry)
{
    parcAssertNotNull(pitEntry, "Parameter pitEntry must be non-null");
...
FibEntry *
pitEntry_GetFibEntry(PitEntry *pitEntry)
{
    parcAssertNotNull(pitEntry, "Parameter pitEntry must be non-null");
...
Ticks
pitEntry_GetExpiryTime(const PitEntry *pitEntry)
{
    parcAssertNotNull(pitEntry, "Parameter pitEntry must be non-null");
...
Ticks
pitEntry_GetCreationTime(const PitEntry *pitEntry)
{
    parcAssertNotNull(pitEntry, "Parameter pitEntry must be non-null");
...
void
pitEntry_SetExpiryTime(PitEntry *pitEntry, Ticks expiryTime)
{
    parcAssertNotNull(pitEntry, "Parameter pitEntry must be non-null");
    pitEntry->expiryTime = expiryTime;
}
...
const NumberSet *
pitEntry_GetIngressSet(const PitEntry *pitEntry)
{
    parcAssertNotNull(pitEntry, "Parameter pitEntry must be non-null");
...
const NumberSet *
pitEntry_GetEgressSet(const PitEntry *pitEntry)
{
    parcAssertNotNull(pitEntry, "Parameter pitEntry must be non-null");
...
Message *
pitEntry_GetMessage(const PitEntry *pitEntry)
{
    parcAssertNotNull(pitEntry, "Parameter pitEntry must be non-null");
