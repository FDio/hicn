 ...
 * @return a pointer to the IoOperations instance associated by th specified connection.
 */
...
void connection_HandleProbe(Connection *conn, uint8_t *message, Ticks actualTime);
