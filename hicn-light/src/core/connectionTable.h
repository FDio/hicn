 ...
 */
void connectionTable_Remove(ConnectionTable *table, const Connection *connection);
 ...
 * Removing the connection will call connection_Release() on the connection object.
 *
 ...
 */
const Connection *connectionTable_FindByAddressPair(ConnectionTable *table, const AddressPair *pair);
