...
//  NOTIFICATION
//    WLDR_NOTIFICATION:  expected_label = window size in the TCP header,  last_received_label = urgent pointer in the TCP header 
//                        ATTENTION!!! in order to detect a notificaiton the source and destination ports must be set to 0
...
void wldr_HandleWldrNotification(Wldr *wldr, const Connection *conn, Message *message);
#endif //wldr_h
