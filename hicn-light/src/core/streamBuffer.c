...
void
streamBuffer_Destroy(PARCEventQueue **bufferPtr)
{
    parcAssertNotNull(bufferPtr, "Parameter must be non-null double pointer");
    parcAssertNotNull(*bufferPtr, "Parameter must dereference to non-null pointer");
    parcEventQueue_Destroy(bufferPtr);
    *bufferPtr = NULL;
}

void
streamBuffer_SetWatermark(PARCEventQueue *buffer, bool setRead, bool setWrite, size_t low, size_t high)
{
...
int
streamBuffer_Flush(PARCEventQueue *buffer, bool flushRead, bool flushWrite)
{
    parcAssertNotNull(buffer, "Parameter buffer must be non-null");
...
int
streamBuffer_FlushCheckpoint(PARCEventQueue *buffer, bool flushRead, bool flushWrite)
{
    parcAssertNotNull(buffer, "Parameter buffer must be non-null");
...
int
streamBuffer_FlushFinished(PARCEventQueue *buffer, bool flushRead, bool flushWrite)
{
    parcAssertNotNull(buffer, "Parameter buffer must be non-null");
...
void
streamBuffer_SetCallbacks(PARCEventQueue *buffer,
...
void
streamBuffer_EnableCallbacks(PARCEventQueue *buffer, bool enableRead, bool enableWrite)
{
    parcAssertNotNull(buffer, "Parameter buffer must be non-null");
    short flags = 0;
    if (enableRead) {
 ...
 */
void
streamBuffer_DisableCallbacks(PARCEventQueue *buffer, bool disableRead, bool disableWrite)
{
    parcAssertNotNull(buffer, "Parameter buffer must be non-null");
    short flags = 0;
    if (disableRead) {
