...
static void
listenerSet_DestroyListenerOps(void **opsPtr)
{
...
listenerSet_Create()
{
    ...
    parcAssertNotNull(set, "parcMemory_AllocateAndClear(%zu) returned NULL", sizeof(ListenerSet));
...
void
listenerSet_Destroy(ListenerSet **setPtr)
{
 ...
 */
bool
listenerSet_Add(ListenerSet *set, ListenerOps *ops)
{
...
size_t
listenerSet_Length(const ListenerSet *set)
{
    parcAssertNotNull(set, "Parameter set must be non-null");
 ...
 */
ListenerOps *
listenerSet_Get(const ListenerSet *set, size_t index)
{
    parcAssertNotNull(set, "Parameter set must be non-null");
...
ListenerOps *
listenerSet_Find(const ListenerSet *set, EncapType encapType, const Address *localAddress)
{
    parcAssertNotNull(set, "Parameter set must be non-null");
