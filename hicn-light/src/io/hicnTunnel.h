 ...
 *
 * Creates a "hicn tunnel" to a remote system.  There must already be a local HICN listener for the
 ...
 *
 * The remoteAddress must be of the same type (i.e. v4 or v6) as the localAddress.  There must be an existing HICN listener
