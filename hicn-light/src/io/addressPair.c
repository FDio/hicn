...
static void
_addressPair_Destroy(AddressPair **addressPairPtr)
{
...
parcObject_ExtendPARCObject(AddressPair, _addressPair_Destroy,
                            NULL, addressPair_ToString, addressPair_Equals, NULL, addressPair_HashCode, NULL);
...
AddressPair *
addressPair_Create(const Address *local, const Address *remote)
{
...
bool
addressPair_Equals(const AddressPair *a, const AddressPair *b)
{
    if (a == b) {
        return true;
    }
...
bool
addressPair_EqualsAddresses(const AddressPair *a, const Address *local, const Address *remote)
{
...
char *
addressPair_ToString(const AddressPair *pair)
{
...
const Address *
addressPair_GetLocal(const AddressPair *pair)
{
    parcAssertNotNull(pair, "Parameter pair must be non-null");
    return pair->local;
}
...
const Address *
addressPair_GetRemote(const AddressPair *pair)
{
    parcAssertNotNull(pair, "Parameter pair must be non-null");
    return pair->remote;
}
 ...
 */
PARCHashCode
addressPair_HashCode(const AddressPair *pair)
{
