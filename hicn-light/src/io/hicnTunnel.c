...
IoOperations *
hicnTunnel_CreateOnListener(Forwarder *forwarder,
                                   ...
                                   const Address *remoteAddress)
{
    ...
    if (localListener->getEncapType(localListener) == ENCAP_HICN) {
        ...
        if (localType == remoteType) {
            ...
            //localAddress = hicnListener_GetTunAddress(localListener); //This is the true local address
...
IoOperations *
hicnTunnel_Create(Forwarder *forwarder, const Address *localAddress, const Address *remoteAddress)
{
