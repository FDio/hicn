...
#define BUFSIZE 4096
#define MAX_CONNECTIONS 255 // We currently limit the number of connections we can establish
...
#define EMPTY_HICN_ADJACENCY (hicn_adjacency_t) {0, 0}
...
typedef struct hicn_socket_s {
    ...
    union {
        struct {
            ...
            /* ID of the corresponding table : avoid default values of 0, 32766 and 32767 */
            uint8_t table_id;
        } connection;
    };
} hicn_socket_t;
