...
static CommandReturn _controlUnset_Execute(CommandParser *parser, CommandOps *ops, PARCList *args);
static CommandReturn _controlUnset_HelpExecute(CommandParser *parser, CommandOps *ops, PARCList *args);
...
CommandOps *
controlUnset_Create(ControlState *state)
{
    return commandOps_Create(state,
                                    _commandUnset,
                                    _controlUnset_Init,
                                    _controlUnset_Execute,
                                    commandOps_Destroy);
}

CommandOps *
controlUnset_HelpCreate(ControlState *state)
{
    return commandOps_Create(state,
                                    _commandUnsetHelp,
                                    NULL,
                                    _controlUnset_HelpExecute,
                                    commandOps_Destroy);
}
...
static void
_controlUnset_Init(CommandParser *parser, CommandOps *ops)
{
...
_controlUnset_HelpExecute(CommandParser *parser, CommandOps *ops, PARCList *args)
{
...
static CommandReturn
_controlUnset_Execute(CommandParser *parser, CommandOps *ops, PARCList *args)
{
