 ...
 * @endcode
 */
ConfigurationFile *configurationFile_Create(Forwarder *forwarder, const char *filename);

/**
 * Reads the configuration file line-by-line and issues commands to Configuration
 *
...
//void configurationFile_ProcessForwardingStrategies(Configuration * config,  ConfigurationFile * configFile);
 ...
 *
 * @param [in,out] configFilePtr An allocated ConfigurationFile that will be NULL'd as output
 *
 * Example:
 * @code
 * <#example#>
