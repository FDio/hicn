 ...
 *
 * @param [in,out] tablePtr A pointer to a SymbolicNameTable, which will be NULL'd
 *
 * Example:
 * @code
 * <#example#>
 ...
 * @endcode
 */
bool symbolicNameTable_Exists(SymbolicNameTable *table, const char *symbolicName);
 ...
 * @endcode
 */
bool symbolicNameTable_Add(SymbolicNameTable *table, const char *symbolicName, unsigned connid);
 ...
 * @endcode
 */
unsigned symbolicNameTable_Get(SymbolicNameTable *table, const char *symbolicName);

void symbolicNameTable_Remove(SymbolicNameTable *table, const char *symbolicName);
const char * symbolicNameTable_GetNameByIndex(SymbolicNameTable *table, unsigned id);
