...
static CommandReturn _controlSet_Execute(CommandParser *parser, CommandOps *ops, PARCList *args);
static CommandReturn _controlSet_HelpExecute(CommandParser *parser, CommandOps *ops, PARCList *args);
...
CommandOps *
controlSet_Create(ControlState *state)
{
...
CommandOps *
controlSet_HelpCreate(ControlState *state)
{
    return commandOps_Create(state,
                                    _commandSetHelp,
                                    NULL,
                                    _controlSet_HelpExecute,
                                    commandOps_Destroy);
}
...
static void
_controlSet_Init(CommandParser *parser, CommandOps *ops)
{
...
_controlSet_HelpExecute(CommandParser *parser, CommandOps *ops, PARCList *args)
{
...
static CommandReturn
_controlSet_Execute(CommandParser *parser, CommandOps *ops, PARCList *args)
{
