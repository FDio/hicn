...
void
commandParser_Destroy(CommandParser **parserPtr)
{
...
void
commandParser_SetDebug(CommandParser *state, bool debugFlag)
{
    state->debugFlag = debugFlag;
}

bool
commandParser_GetDebug(CommandParser *state)
{
    return state->debugFlag;
}

void
commandParser_RegisterCommand(CommandParser *state, CommandOps *ops)
{
 ...
 */
static CommandOps *
commandParser_MatchCommand(CommandParser *state, PARCList *args)
{
...
CommandReturn
commandParser_DispatchCommand(CommandParser *state, PARCList *args)
{
...
bool
commandParser_ContainsCommand(CommandParser *parser, const char *command)
{
