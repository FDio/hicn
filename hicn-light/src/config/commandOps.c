...
CommandOps *
commandOps_Create(void *closure,
                         const char *command,
                         void (*init)(CommandParser *parser, CommandOps *ops),
                         ...
                         void (*destroyer)(CommandOps **opsPtr))
{
    ...
    parcAssertNotNull(ops, "parcMemory_AllocateAndClear(%zu) returned NULL", sizeof(CommandOps));
...
void
commandOps_Destroy(CommandOps **opsPtr)
{
