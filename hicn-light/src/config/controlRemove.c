...
static CommandReturn _controlRemove_Execute(CommandParser *parser, CommandOps *ops, PARCList *args);
static CommandReturn _controlRemove_HelpExecute(CommandParser *parser, CommandOps *ops, PARCList *args);
...
CommandOps *
controlRemove_Create(ControlState *state)
{
    return commandOps_Create(state,
                                    _commandRemove,
                                    _controlRemove_Init,
                                    _controlRemove_Execute,
                                    commandOps_Destroy);
}

CommandOps *
controlRemove_HelpCreate(ControlState *state)
{
    return commandOps_Create(state,
                                    _commandRemoveHelp,
                                    NULL,
                                    _controlRemove_HelpExecute,
                                    commandOps_Destroy);
}
...
_controlRemove_HelpExecute(CommandParser *parser, CommandOps *ops, PARCList *args)
{
...
static void
_controlRemove_Init(CommandParser *parser, CommandOps *ops)
{
    ControlState *state = ops->closure;
    controlState_RegisterCommand(state, controlRemoveConnection_HelpCreate(state));
...
static CommandReturn
_controlRemove_Execute(CommandParser *parser, CommandOps *ops, PARCList *args)
{
