 ...
 * @brief Creates a dictionary of commands and parses a command_line to match against them
 *
 * A user creates individual CommandParserEntry that map a command_line to a function
 * to execute.  The CommandParser then does a longest-matching prefix match of a command_line
 ...
 * @endcode
 */
CommandReturn commandParser_DispatchCommand(CommandParser *state, PARCList *args);
