...
static CommandReturn _controlAdd_Execute(CommandParser *parser, CommandOps *ops, PARCList *args);
static CommandReturn _controlAdd_HelpExecute(CommandParser *parser, CommandOps *ops, PARCList *args);
...
CommandOps *
webControlAdd_Create(ControlState *state)
{
...
CommandOps *
controlAdd_CreateHelp(ControlState *state)
{
    return commandOps_Create(state,
                                    help_command_add,
                                    NULL,
                                    _controlAdd_HelpExecute,
                                    commandOps_Destroy);
}
...
_controlAdd_HelpExecute(CommandParser *parser, CommandOps *ops, PARCList *args)
{
...
static void
_controlAdd_Init(CommandParser *parser, CommandOps *ops)
{
...
static CommandReturn
_controlAdd_Execute(CommandParser *parser, CommandOps *ops, PARCList *args)
{
