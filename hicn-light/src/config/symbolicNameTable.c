...
static bool
_connectionIdEquals(const void *keyA, const void *keyB)
{
...
static HashCodeType
_connectionIdHash(const void *keyA)
{
    unsigned idA = *((unsigned  *) keyA);
...
symbolicNameTable_Create(void)
{
    ...
    if (table) {
        ...
        table->indexToNameTable = parcHashCodeTable_Create(_connectionIdEquals, _connectionIdHash, parcMemory_DeallocateImpl, parcMemory_DeallocateImpl);
    }
...
void
symbolicNameTable_Destroy(SymbolicNameTable **tablePtr)
{
...
bool
symbolicNameTable_Exists(SymbolicNameTable *table, const char *symbolicName)
{
...
void
symbolicNameTable_Remove(SymbolicNameTable *table, const char *symbolicName)
{
    parcAssertNotNull(table, "Parameter table must be non-null");
    parcAssertNotNull(symbolicName, "Parameter symbolicName must be non-null");
...
bool
symbolicNameTable_Add(SymbolicNameTable *table, const char *symbolicName, unsigned connid)
{
    parcAssertNotNull(table, "Parameter table must be non-null");
    parcAssertNotNull(symbolicName, "Parameter symbolicName must be non-null");
    parcAssertTrue(connid < UINT32_MAX, "Parameter connid must be less than %u", UINT32_MAX);
...
unsigned
symbolicNameTable_Get(SymbolicNameTable *table, const char *symbolicName)
{
    parcAssertNotNull(table, "Parameter table must be non-null");
    parcAssertNotNull(symbolicName, "Parameter symbolicName must be non-null");
...
const char *
symbolicNameTable_GetNameByIndex(SymbolicNameTable *table, unsigned id)
{
    parcAssertNotNull(table, "Parameter table must be non-null");
