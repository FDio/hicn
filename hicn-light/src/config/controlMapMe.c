...
static CommandReturn _controlMapMe_Execute(CommandParser *parser, CommandOps *ops, PARCList *args);
static CommandReturn _controlMapMe_HelpExecute(CommandParser *parser, CommandOps *ops, PARCList *args);

static const char *_commandMapMe = "mapme";
static const char *_commandMapMeHelp = "help mapme";

CommandOps *
controlMapMe_Create(ControlState *state)
{
    return commandOps_Create(state,
                                    _commandMapMe,
                                    _controlMapMe_Init,
                                    _controlMapMe_Execute,
                                    commandOps_Destroy);
}

CommandOps *
controlMapMe_HelpCreate(ControlState *state)
{
    return commandOps_Create(state,
                                    _commandMapMeHelp,
                                    NULL,
                                    _controlMapMe_HelpExecute,
                                    commandOps_Destroy);
}
...
_controlMapMe_HelpExecute(CommandParser *parser, CommandOps *ops, PARCList *args)
{
...
static void
_controlMapMe_Init(CommandParser *parser, CommandOps *ops)
{
...
static CommandReturn
_controlMapMe_Execute(CommandParser *parser, CommandOps *ops, PARCList *args)
{
