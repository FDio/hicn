...
static CommandReturn _controlCache_Execute(CommandParser *parser, CommandOps *ops, PARCList *args);
static CommandReturn _controlCache_HelpExecute(CommandParser *parser, CommandOps *ops, PARCList *args);

static const char *_commandCache = "cache";
static const char *_commandCacheHelp = "help cache";

CommandOps *
controlCache_Create(ControlState *state)
{
    return commandOps_Create(state,
                                    _commandCache,
                                    _controlCache_Init,
                                    _controlCache_Execute,
                                    commandOps_Destroy);
}

CommandOps *
controlCache_HelpCreate(ControlState *state)
{
    return commandOps_Create(state,
                                    _commandCacheHelp,
                                    NULL,
                                    _controlCache_HelpExecute,
                                    commandOps_Destroy);
}
...
_controlCache_HelpExecute(CommandParser *parser, CommandOps *ops, PARCList *args)
{
...
static void
_controlCache_Init(CommandParser *parser, CommandOps *ops)
{
...
static CommandReturn
_controlCache_Execute(CommandParser *parser, CommandOps *ops, PARCList *args)
{
