...
static inline
void face_tags_add(face_tags_t * tags, face_tag_t tag)
{
    *tags |= tag;
}

static inline
void face_tags_remove(face_tags_t * tags, face_tag_t tag)
{
    *tags &= ~tag;
}

static inline
int face_tags_has(face_tags_t tags, face_tag_t tag)
{
    return tags & tag;
}
...
int face_initialize_udp(face_t * face, const ip_address_t * local_addr,
        ...
        int family);
face_t * face_initialize_udp_sa(face_t * face,
