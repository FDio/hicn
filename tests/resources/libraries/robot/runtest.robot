...
Run Test
    [Arguments]    ${TEST_TOPOLOGY}=${NONE}    ${TEST_SETUP}=${NONE}    ${TESTID}=${NONE}    ${EXPECTED_MIN}=${NONE}    ${EXPECTED_MAX}=${NONE}    ${EXPECTED_AVG}=${NONE}
...
Run Throughput Test Raaqm
    [Documentation]    Run hiperf on the \${TEST_TOPOLOGY}-\${TEST_SETUP} topology and measure throughput.
    ...    Arguments:
    ...    ${TEST_TOPOLOGY} The topology of the test.
    ...    ${TEST_SETUP} The setup of the test.
...
Run RTC Test
    ...
    ...    ${EXPECTED_MAX}=${NONE}
    ...    ${EXPECTED_AVG}=${NONE}
    Run Test    ${TEST_TOPOLOGY}    ${TEST_SETUP}    rtc    ${EXPECTED_MIN}    ${EXPECTED_MAX}    ${EXPECTED_AVG}
