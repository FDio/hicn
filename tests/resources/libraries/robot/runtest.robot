...
Run Test
    ...
    ${result_test} =    Run Process                              ${EXECDIR}/config.sh                                               getlogs
    ${output}           Get File                                 /tmp/lite_client_server.log
    Log To Console      HICN LIGHT FORWARDER: ${output.strip()}
    ${output}           Get File                                 /tmp/lite_server.log
    Log To Console      HICN LIGHT FORWARDER: ${output.strip()}
    ${output}           Get File                                 /tmp/hiperf.log
    Log To Console      HIPERF: ${output.strip()}
