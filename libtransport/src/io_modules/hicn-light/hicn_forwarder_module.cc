...
HicnForwarderModule::ForwarderUrlInitializer HicnForwarderModule::forwarder_url_initializer_;

HicnForwarderModule::HicnForwarderModule()
    : IoModule(), connector_(nullptr), seq_(0) {
  std::cout << forwarder_url_initializer_.getForwarderUrl() << std::endl;
}
