...
static constexpr uint32_t content_object_packet_size = 1500;  // The ethernet MTU
static constexpr uint32_t producer_socket_input_buffer_size = 150000;   // Interests
static constexpr uint32_t producer_socket_output_buffer_size = 150000;  // Content Object
