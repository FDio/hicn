...
vlib_node_registration_t hicn_interest_handoff_4_node;
vlib_node_registration_t hicn_interest_handoff_6_node;
vlib_node_registration_t hicn_data_handoff_4_node;
vlib_node_registration_t hicn_data_handoff_6_node;
...
hicn_handoff_init()
{
  ...
  hicn_handoff_main.frame_queue_index_data_6 =  vlib_frame_queue_main_init (hicn6_face_input_node.index, 0);
  hicn_handoff_main.frame_queue_index_data_4 =  vlib_frame_queue_main_init (hicn4_face_input_node.index, 0);
}
...
get_hash_key(const ip6_header_t * header, u8 is_interest)
{
  ...
  return address[0] + address[1] + ((tcp_header_t *)(header + 1))->seq_number;
}
...
VLIB_NODE_FN (hicn_data_handoff_4_node) (vlib_main_t * vm, vlib_node_runtime_t * node,
			    	  	 vlib_frame_t * frame)
{
  return hicn_handoff_fn_inline(vm, node, frame, hicn_handoff_main.frame_queue_index_data_4, /* is_interest */ 0);
}
...
// /* *INDENT-OFF* */
// VNET_FEATURE_INIT(hicn_data_handoff_6_arc, static)=
//     {
//      .arc_name = "ip6-local",
...
// /* *INDENT-OFF* */
// VNET_FEATURE_INIT(hicn_data_handoff_4_arc, static)=
//     {
//      .arc_name = "ip4-local",
