...
STATIC_ASSERT (64 == offsetof (hicn_pcs_entry_t, cacheline1),
	       "Cacheline1 must be at byte 64 of hicn_pcs_entry_t");
...
STATIC_ASSERT (128 == offsetof (hicn_pcs_entry_t, u.pit.cacheline2),
	       "Cacheline2 must be at byte 128 of hicn_pcs_entry_t");
