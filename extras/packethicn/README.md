...
```bash
$ curl -s https://packagecloud.io/install/repositories/fdiorelease/script.deb.sh | sudo bash

$ sudo apt install -y build-essential cmake libhicn-dev wireshark-dev libgcrypt-dev libgnutls28-dev
