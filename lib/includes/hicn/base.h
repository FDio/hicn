...
#define HICN_PACKET_FORMAT_IS_IPV4(format) (HICN_PACKET_FORMAT_GET (format, 0) == IPPROTO_IP)
#define HICN_PACKET_FORMAT_IS_IPV6(format) (HICN_PACKET_FORMAT_GET (format, 0) == IPPROTO_IPV6)
