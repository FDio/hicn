 ...
 * @return hICN error code
 */
int hicn_packet_check_integrity(hicn_format_t format, hicn_header_t *packet);
 ...
 * @return hICN error code
 */
int hicn_packet_set_payload_length(hicn_format_t format, hicn_header_t *packet,
 ...
 * into the payload buffer, otherwise (0) the pointer is changed to point to the
...
int hicn_packet_get_signature_size(hicn_format_t format,
                                   const hicn_header_t *packet, size_t *bytes);
 ...
 * @return hICN error code
 */
int hicn_packet_set_signature_size(hicn_format_t format, hicn_header_t *packet,
                                   size_t bytes);
