...
static_assert(EXPECTED_MAPME_V4_HDRLEN == HICN_MAPME_V4_HDRLEN, "Size of MAPME_V4 struct does not match its expected size.");
static_assert(EXPECTED_MAPME_V6_HDRLEN == HICN_MAPME_V6_HDRLEN, "Size of MAPME_V6 struct does not match its expected size.");
