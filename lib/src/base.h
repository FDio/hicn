...
#define HICN_TYPE_F(name, x, y, z, t)   \
always_inline hicn_type_t               \
name(int l1, int l2, int l3, int l4) {  \
    hicn_type_t type;                   \
    type.l1 = x;                        \
    type.l2 = y;                        \
    type.l3 = z;                        \
...
HICN_TYPE_F( HICN_TYPE_IPV4_TCP,     IPPROTO_IP,   IPPROTO_TCP,    IPPROTO_NONE, IPPROTO_NONE );
HICN_TYPE_F( HICN_TYPE_IPV4_ICMP,    IPPROTO_IP,   IPPROTO_ICMP,   IPPROTO_NONE, IPPROTO_NONE );
HICN_TYPE_F( HICN_TYPE_IPV6_TCP,     IPPROTO_IPV6, IPPROTO_TCP,    IPPROTO_NONE, IPPROTO_NONE );
HICN_TYPE_F( HICN_TYPE_IPV6_ICMP,    IPPROTO_IPV6, IPPROTO_ICMPV6, IPPROTO_NONE, IPPROTO_NONE );
HICN_TYPE_F( HICN_TYPE_IPV4_TCP_AH,  IPPROTO_IP,   IPPROTO_TCP,    IPPROTO_NONE, IPPROTO_NONE );
HICN_TYPE_F( HICN_TYPE_IPV4_ICMP_AH, IPPROTO_IP,   IPPROTO_ICMP,   IPPROTO_NONE, IPPROTO_NONE );
HICN_TYPE_F( HICN_TYPE_IPV6_TCP_AH,  IPPROTO_IPV6, IPPROTO_TCP,    IPPROTO_AH,   IPPROTO_NONE );
HICN_TYPE_F( HICN_TYPE_IPV6_ICMP_AH, IPPROTO_IPV6, IPPROTO_ICMPV6, IPPROTO_AH,   IPPROTO_NONE );
HICN_TYPE_F( HICN_TYPE_NONE,         IPPROTO_NONE, IPPROTO_NONE,   IPPROTO_NONE, IPPROTO_NONE );
