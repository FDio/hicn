...
/*
    ...
    sr_val_set_xpath(&vals[12], "/hicn:hicn-state/states/interests_hash_collision");
...
*/
    ...
    rc = sr_dp_get_items_subscribe(session, "/hicn:hicn-state/states/pkts_processed", hicn_state_cb, NULL, SR_SUBSCR_CTX_REUSE, subscription);
    if (rc != SR_ERR_OK) {
        goto error;
    }
